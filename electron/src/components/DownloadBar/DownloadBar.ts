...
import {요소_값_반환, 요소_찾기, 인풋_값_반환} from '../../js/domUtility/domUtility.js';
...
export default class 다운로드_바 extends 컴포넌트 {
  ...
  이벤트_설정() {
    ...
    const 엑셀_다운로드_버튼 = 요소_찾기(부모, 엑셀_다운로드_버튼_선택자) as HTMLButtonElement;
    ...
    const 이미지_다운로드_버튼 = 요소_찾기(부모, 이미지_다운로드_버튼_선택자) as HTMLButtonElement;
