...
import 검색_유형 from '../검색_유형/검색_유형';
import 검색바_키워드 from '../SearchBarKeyword/SearchBarKeyword';
import 검색바_브랜드 from '../SearchBarBrand/SearchBarBrand';
import 검색_결과 from '../SearchResult/SearchResult';
import 다운로드_바 from '../DownloadBar/DownloadBar';
...
export default class 헤더 extends 컴포넌트 {
  ...
  검색_유형_컴포넌트_생성() {
    const 속성 = {};
    const 컨테이너 = this.부모.querySelector('[data-component="search-type-container"]') as HTMLDivElement;
    const 검색_유형_컴포넌트 = new 검색_유형();
  }
